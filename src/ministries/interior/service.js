...
const DB_PASS = 'interior_db_password_123';
const FLAG = 'FLAG{interior_flag_01}';
const BACKUP_FLAG = 'FLAG{interior_backup_01}';
const ADMIN_CREDS = {
    username: 'admin',
    password: 'admin123'
};
...
const INTERNAL_TOKEN = 'interior_internal_token_123';
...
async function searchRecords(query) {
    ...
    const [rows] = await db.query(`SELECT * FROM facilities WHERE description LIKE '%${query}%'`);
    return rows;
}
